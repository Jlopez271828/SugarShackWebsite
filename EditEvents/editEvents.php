...
<body>
  ...
  <form onsubmit="return false">
    ...
    <textarea id="announcements" name="announcements" ><?php echo($configData['announcements']);?></textarea>

    <label for="events">Events:</label>
    <textarea id="events" name="events"><?php echo($configData['events']);?></textarea>
